"""Production settings for ProjectA (Bookshop) — used on Render.

Imports the base development settings, then overrides debug, security,
database URL parsing, ALLOWED_HOSTS, and inter-service URLs.
"""
import os
...
SECRET_KEY = env("PROJECTA_SECRET_KEY")
if not SECRET_KEY:
...
# ---------------------------------------------------------------------------
# Cache & Celery — single REDIS_URL from Render
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# CORS / CSRF — frontend origin set via env after first deploy
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# DRF — stricter in production (no browsable API)
# ---------------------------------------------------------------------------
